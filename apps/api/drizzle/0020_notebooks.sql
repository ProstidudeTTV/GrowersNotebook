-- NOTEBOOK grow-diary + nutrient catalog + profile privacy flag
DO $t$ BEGIN
...
CREATE TABLE "notebook_week_nutrients" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE INDEX "notebooks_owner_updated_idx" ON "notebooks" USING btree ("owner_id","updated_at");
CREATE INDEX "notebooks_strain_idx" ON "notebooks" USING btree ("strain_id");
CREATE INDEX "notebook_weeks_notebook_idx" ON "notebook_weeks" USING btree ("notebook_id");
CREATE INDEX "nutrient_products_published_name_idx" ON "nutrient_products" USING btree ("published","name");
CREATE INDEX "notebook_week_nutrients_week_idx" ON "notebook_week_nutrients" USING btree ("week_id");
CREATE INDEX "notebook_votes_notebook_idx" ON "notebook_votes" USING btree ("notebook_id");
CREATE INDEX "notebook_comments_notebook_created_idx" ON "notebook_comments" USING btree ("notebook_id","created_at");
CREATE INDEX "notebook_comments_parent_idx" ON "notebook_comments" USING btree ("parent_id");
