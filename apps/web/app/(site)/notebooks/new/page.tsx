      ...
      {!wizardOpen ? (
        <main className="mx-auto max-w-lg px-4 py-8">
          ...
          <p className="mt-1 text-sm text-[var(--gn-text-muted)]">
            We&apos;ll walk you through name, setup, and environment. Your
            diary is only saved when you finish—closing early does not create an
            empty notebook. After that, this page shows your summary and weekly
            entries;{" "}
