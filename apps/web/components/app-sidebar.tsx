...
import { MessagesUnreadDot } from "@/components/sidebar-messages-link";
        ...
        <div className="mt-2 space-y-0.5">
          ...
          {isStaff ? (
            <Link
              ...
              onClick={afterNav}
              aria-current={navAriaCurrent("/admin")}
            >
              <NavIcon color="bg-amber-500/15 text-amber-600 dark:text-amber-400">
                <svg
