            ...
            <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 flex-wrap gap-2">
                <button
                  type="button"
                  disabled={!can}
                  className="rounded-lg bg-[var(--gn-accent)] px-3 py-2 text-xs font-semibold text-white shadow-[0_0_12px_rgba(255,69,0,0.25)] transition hover:brightness-110 disabled:opacity-50"
                  onClick={() => applyLink()}
                >
