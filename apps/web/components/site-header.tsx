      ...
      <div className="hidden w-full flex-col lg:flex">
        <div className="flex min-h-14 w-full min-w-0">
          <div className="flex w-56 shrink-0 items-center px-2 py-3">
            <Link
              href="/"
              className="flex min-w-0 items-center rounded-lg px-2 py-2 transition hover:opacity-90"
              aria-label="Growers Notebook home"
            >
              <SiteLogo className="h-9 w-auto max-w-[10.5rem]" />
            </Link>
          </div>
      ...
      <div className="flex flex-col lg:hidden">
        <div className="flex min-h-14 min-w-0 items-center justify-between gap-2 px-3 py-3 sm:gap-4 sm:px-4">
          <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/"
              className="flex min-w-0 flex-1 items-center gap-2 truncate rounded-lg transition hover:opacity-90"
              aria-label="Growers Notebook home"
            >
              <SiteLogoMark className="h-8 w-6 shrink-0 sm:h-9 sm:w-7" />
              <SiteLogo className="hidden h-8 w-auto max-w-[9.5rem] shrink-0 sm:block" />
            </Link>
          </div>
