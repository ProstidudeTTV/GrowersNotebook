    ...
    <header className="gn-header sticky top-0 z-[100]">
      ...
      <div className="hidden w-full flex-col lg:flex">
        <div className="flex min-h-14 w-full min-w-0">
          <div className="flex w-56 shrink-0 items-center px-3 py-2">
            <Link
              href="/"
              className="flex min-w-0 flex-1 items-center rounded-lg py-1.5 transition hover:opacity-90"
      ...
      <div className="flex flex-col lg:hidden">
        <div className="flex min-h-14 min-w-0 items-center justify-between gap-2 px-3 py-3 sm:gap-4 sm:px-4">
          <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/"
              className="flex min-w-0 flex-1 items-center rounded-lg transition hover:opacity-90"
              aria-label="Growers Notebook home"
            >
              <SiteBrand size="sm" className="hidden min-w-0 sm:flex" />
              <SiteLogoMark className="h-8 w-6 shrink-0 sm:hidden" />
            </Link>
          </div>
